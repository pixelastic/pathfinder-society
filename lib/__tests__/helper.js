...
describe('helper', () => {
  ...
  describe('ruleVersion', () => {
    it('Black Waters', async () => {
      ...
      const actual = module.ruleVersion(input);
  ...
  describe('seasonIndex', () => {
    it('Black Waters', async () => {
      ...
      const actual = module.seasonIndex(input);
  ...
  describe('isReleased', () => {
    it('Black Waters', async () => {
      ...
      const actual = module.isReleased(input);
  ...
  describe('scenario', () => {
    ...
    it('Star-Crossed Voyages', async () => {
      const actual = await module.scenario(testName);
